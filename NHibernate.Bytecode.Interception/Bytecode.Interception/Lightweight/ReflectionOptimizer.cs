...
namespace NHibernate.Bytecode.Interception.Lightweight
{
	public class ReflectionOptimizer : IReflectionOptimizer, IInstantiationOptimizer
	{
		...
		{
            object instance = interceptor.CreateInstance(mappedType);
            if (instance == null)
            {
        ...
        /// Class constructor.
        /// </summary>
        public ReflectionOptimizer(System.Type mappedType, IGetter[] getters, ISetter[] setters, IBytecodeProviderInterceptor interceptor)
            : this(mappedType, getters, setters)
        {
		...
		protected virtual CreateInstanceInvoker CreateCreateInstanceMethod(System.Type type)
		{
            ...
            //var pow = typeof(System.Math).GetMethod("Create", BindingFlags.Static);
            ...
            //return (CreateInstanceInvoker)powIt.CreateDelegate(typeof(CreateInstanceInvoker));
